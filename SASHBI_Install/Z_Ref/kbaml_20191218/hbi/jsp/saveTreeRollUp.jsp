...
<% 
	...
	String objTreeMStats = request.getParameter("objTreeMStats");
	String objFlatMStats = request.getParameter("objFlatMStats");
	...
	*/
	...
	String SUB_TYPE = "";	//request.getParameter("TREE_TYPE");
	...
	if (TREE_ID != "" ) {
		//UDReport.updateReportInfo(TREE_ID,RPT_TYPE,AUTH_GROUP,LIBRARY,DATA_NAME,treeGroup,treeName,treeDesc,userID);
		UDReport.updateReportInfo(TREE_ID,ACCT_GROUP,TREE_TYPE,SUB_TYPE,LIBNAME,DATA_NAME,RPT_GRP_ID,TREE_NAME,TREE_DESC,USERID,AUTH_GROUP);
		UDReport.updateReportLayout(objTreeLayout,objFlatLayout,objTreeFilter,objTreeMStats,objFlatMStats,TREE_ID);
	} else {
		TREE_ID = UDReport.insertReportLayout(objTreeLayout,objFlatLayout,objTreeFilter,objTreeMStats,objFlatMStats); 
		//UDReport.insertReportInfo(TREE_ID,RPT_TYPE,AUTH_GROUP,LIBRARY,DATA_NAME,treeGroup,treeName,treeDesc,userID);
		UDReport.insertReportInfo(TREE_ID,ACCT_GROUP,TREE_TYPE,SUB_TYPE,LIBNAME,DATA_NAME,RPT_GRP_ID,TREE_NAME,TREE_DESC,USERID,AUTH_GROUP);
	}
/*
*/
%>
