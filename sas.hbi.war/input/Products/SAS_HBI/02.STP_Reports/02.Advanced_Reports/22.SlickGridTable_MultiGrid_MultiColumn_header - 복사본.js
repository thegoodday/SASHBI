...
function CreateAddlHeaderRow() {
	console.log("CreateAddlHeaderRow");
	console.log(columns);
...
function setSlickGrid(data){			//, dvRefID, sgGrid){
	...
	columns[5].columnGroup ="Region";
	columns[6].columnGroup ="Analysis";
	columns[7].columnGroup ="Analysis";
	columns[8].columnGroup ="Analysis";
    ...
    sgGrid.onColumnsResized.subscribe(function (e, args) {
		CreateAddlHeaderRow();//sgGrid, columns);
    });
