...
function fnAddAttachGrid() {
    ...
    //var dataView = sgGridAttachFiles.get;
...
function getAttachFiles(rowInfo) {
    ...
    execAjax(
        "",
        "SBIP://NETASERVER/Products/SAS HBI/00.Environments/StoredProcess/02.STP Reports/01.Board_hw/hw_getAttachFiles(StoredProcess)",
        true,
        "cbGetAttachFiles",
        "json",
        debug
