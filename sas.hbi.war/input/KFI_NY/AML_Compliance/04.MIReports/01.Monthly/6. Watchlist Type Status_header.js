...
function setSlickGrid(data){	
	...
	columns[1].columnGroup = "공통 리스트";
	columns[2].columnGroup = "공통 리스트";
	columns[3].columnGroup = "공통 리스트";
	columns[4].columnGroup = "공통 리스트";
	columns[5].columnGroup = "공통 리스트";
	columns[6].columnGroup = "PEP";
	columns[7].columnGroup = "PEP";
	columns[8].columnGroup = "PEP";
	columns[9].columnGroup = "PEP";
	columns[10].columnGroup = "PEP";
