...
function setSlickGrid(data){	
	...
	columns[5].columnGroup = "금월";
	columns[6].columnGroup = "전체고객";
	columns[7].columnGroup = "전체고객";
	columns[8].columnGroup = "전체고객";
	columns[9].columnGroup = "전체고객";
	columns[10].columnGroup = "전체고객";
