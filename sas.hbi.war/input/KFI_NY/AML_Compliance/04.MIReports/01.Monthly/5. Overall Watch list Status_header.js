...
function setSlickGrid(data){	
	...
	columns[1].columnGroup = "공통리스트";
	columns[2].columnGroup = "공통리스트";
	columns[3].columnGroup = "개별업로드";
	columns[4].columnGroup = "개별업로드";
	columns[5].columnGroup = "패키지";
	columns[6].columnGroup = "패키지";
