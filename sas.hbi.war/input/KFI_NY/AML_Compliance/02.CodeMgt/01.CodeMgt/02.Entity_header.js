...
function setSlickGrid(data){
	...
	//Get Max Sequence
	$sasResHTML=execSTPA("SBIP://METASERVER/KFI_NY/AML Compliance/00.Environments/StoredProcess/0202_Entity_getMaxSeq(StoredProcess)",'fnSetMaxSeq');
...
function fnConfirmSaveGrid1(){
	...
	tParams['_tablename']="fsb_crr_entity_score";
	tParams['_program']="SBIP://METASERVER/KFI_NY/AML Compliance/00.Environments/StoredProcess/0202_Entity_saveRiskScore(StoredProcess)";
	console.log("gridData : ");
	console.log(gridData);
	console.log(tParams);
