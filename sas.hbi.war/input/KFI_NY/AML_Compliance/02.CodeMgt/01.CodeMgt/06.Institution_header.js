...
function setSlickGrid(data){
	...
	//Get Max Sequence
	$sasResHTML=execSTPA("SBIP://METASERVER/KFI_NY/AML Compliance/00.Environments/StoredProcess/0206_Institution_getMaxSeq(StoredProcess)",'fnSetMaxSeq');
